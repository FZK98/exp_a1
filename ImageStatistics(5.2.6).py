...
print('the mean of our distribution is: ', popt[1])
print('the standard deviation of our distribution is: ',  popt[2])
print('the amplitude of our distribution is: ',  popt[0])
